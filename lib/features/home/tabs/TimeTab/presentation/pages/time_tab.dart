            ...
            Column(
              ...
              children: [
                SizedBox(
                    ...
                    height: height*0.4,
                  child: FutureBuilder(future: ApiManager.getPrayerDate(),
                    ...
                    return Container(
                      decoration: BoxDecoration(
                          image: DecorationImage(image: AssetImage(AppAssets.prayerTimeBg))
                      ),
                      child: Stack(
                          ...
                          Positioned(
                            top:18,
                              ...
                              child: Row(
                                ...
                                crossAxisAlignment: CrossAxisAlignment.start,
                                children: [
                                  AutoSizeText(DateFormatter.formatGregorian(data.data!.date!.gregorian!),style: AppStyles.bold16White),
                                  Column(
                                    children: [
                                      AutoSizeText(AppStrings.prayTime,style: AppStyles.bold20PrimaryDark.copyWith(color: AppColors.darkGold)),
                                      Text(data.data!.date!.gregorian!.weekday!.en!,style: AppStyles.bold20PrimaryDark)
                                    ],
                                  ),
                                  AutoSizeText(DateFormatter.formatHijri(data.data!.date!.hijri!),style: AppStyles.bold16White)
                                ],
                              )
                          ),
                          Column(
                                      ...
                                      child: Column(
                                        children: [
                                          Padding(
                                            ...
                                            child: Text(prayerTimes.keys.elementAt(index),style: AppStyles.bold20White),
                                          ),
                                          Text(TimeConverter.to12Hours(prayerTimes.values.elementAt(index)),style: AppStyles.bold26White,textAlign: TextAlign.center)
                                        ],
                                      ),
                                    );
                                  },
